...
class Program
{
     static void Main(string[] args)
    {
        ...
        #region Bonus multiply 2 matrix 3*2    *  2*1  =  3*1
        ...
        #region Bonus multiply 2 matrix  3*3     *    3*2   =  3*2
